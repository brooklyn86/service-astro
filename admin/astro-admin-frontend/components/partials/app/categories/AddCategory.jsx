...
import { toggleAddModal, pushCategory } from "./store";
...
const AddCategory = () => {
  const { openCategoryModal } = useSelector((state) => state.category);
  ...
  const FormValidationSchema = yup
    .object({
      ...
      active: yup.string().required("Title is required"),
    })
    .required();
  ...
  const onSubmit = (data) => {
    ...
    dispatch(pushCategory({ title , active }));
