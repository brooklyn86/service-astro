...
import { toggleAddModal, pushClient } from "./store";
...
const AddClient = () => {
  const { openClientModal } = useSelector((state) => state.client);
  ...
  const FormValidationSchema = yup
    .object({
      ...
      cnpj: yup.mixed().required("Assignee is required"),
      active: yup.mixed().required("Tag is required"),
    })
    .required();
