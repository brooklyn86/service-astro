...
import { removeClient, updateClient } from "./store";
  ...
  const actions = [
    {
      ...
      doit: (item) => router.push(`/clients/${item.id}`),
    },
    {
      name: "edit",
      icon: "heroicons:pencil-square",
      doit: (item) => dispatch(updateClient(item)),
    },
    {
      name: "delete",
      icon: "heroicons-outline:trash",
      doit: (item) => dispatch(removeClient(item.id)),
    },
  ];
